...
/**
 * Cluster Alternative Pairing
 *    The Alternative Pairing cluster is meant to be used to pair other devices with node id.
 */
MTR_PROVISIONALLY_AVAILABLE
@interface MTRClusterAlternativePairing : MTRGenericCluster

- (void)pairWithParams:(MTRAlternativePairingClusterPairParams *)params expectedValues:(NSArray<NSDictionary<NSString *, id> *> * _Nullable)expectedDataValueDictionaries expectedValueInterval:(NSNumber * _Nullable)expectedValueIntervalMs completion:(MTRStatusCompletion)completion MTR_PROVISIONALLY_AVAILABLE;

- (NSDictionary<NSString *, id> * _Nullable)readAttributeDevicesCountWithParams:(MTRReadParams * _Nullable)params MTR_PROVISIONALLY_AVAILABLE;
...
@interface MTRClusterAlternativePairing (Availability)
