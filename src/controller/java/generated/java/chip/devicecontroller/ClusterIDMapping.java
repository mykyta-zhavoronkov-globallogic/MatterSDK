...
public class ClusterIDMapping {
    ...
    public static BaseCluster getCluster(long clusterId) {
        ...
        if (clusterId == AlternativePairing.ID) {
            return new AlternativePairing();
        }return null;
    }
    ...
    public static class AlternativePairing implements BaseCluster {
        public static final long ID = 4294179900L;
        public long getID() {
            return ID;
        }
        ...
        public enum Command {
            ...
            public static Command value(long id) throws NoSuchFieldError {
                ...
                throw new NoSuchFieldError();
        ...
        }public enum PairCommandField {NodeId(0),;
                    private final int id;
                    PairCommandField(int id) {
                        this.id = id;
                    }
                    ...
                    public static PairCommandField value(int id) throws NoSuchFieldError {
                        for (PairCommandField field : PairCommandField.values()) {
                        if (field.getID() == id) {
                            return field;
                        }
                        }
