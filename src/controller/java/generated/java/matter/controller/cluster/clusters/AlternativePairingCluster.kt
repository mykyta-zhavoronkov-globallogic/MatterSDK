...
class AlternativePairingCluster(
  ...
  suspend fun pair(nodeId: ULong, timedInvokeTimeout: Duration? = null) {
  ...
  suspend fun readDevicesCountAttribute(): UInt {
    ...
    requireNotNull(attributeData) { "Devicescount attribute not found in response" }
  ...
  suspend fun subscribeDevicesCountAttribute(
    minInterval: Int,
    maxInterval: Int,
    ...
    return controller.subscribe(subscribeRequest).transform { subscriptionState ->
      when (subscriptionState) {
        ...
        is SubscriptionState.NodeStateUpdate -> {
          ...
          requireNotNull(attributeData) { "Devicescount attribute not found in Node State update" }
  ...
  companion object {
    private val logger = Logger.getLogger(AlternativePairingCluster::class.java.name)
    const val CLUSTER_ID: UInt = 4294179900u
  }
}
